...
public class DivisasValidas {
    public String[] DIVISAS_VALIDAS = {
        ...
        "SDG", "SEK", "SGD", "SHP", "SLE", "SLL", "SOS", "SRD", "SSP", "STN", "SYP",
        "SZL", "THB", "TJS", "TMT", "TND", "TOP", "TRY", "TTD", "TVD", "TWD", "TZS",
        "UAH", "UGX", "USD", "UYU", "UZS", "VES", "VND", "VUV", "WST", "XAF", "XCD",
        "XOF", "XPF", "YER", "ZAR", "ZMW", "ZWL"
    };
    public boolean esDivisaValida(String divisa) {
        // Convertir el array a una lista y verificar si contiene monedaBase
        return Arrays.asList(DIVISAS_VALIDAS).contains(divisa);
    }

    @Override
    public String toString() {
        return Arrays.toString(DIVISAS_VALIDAS);
    }
